...
```{r echo = FALSE, message=FALSE, fig.cap="Number of available Landsat (4-8) images by path (upper border) and row (right border) of Mexico's surface between 1972 - 2017. Additionally, the percentage of images by cloud cover percentage is shwon by the bar color. Figure from Solórzano et al. (2020)."}
